...
export default function MaintDetail({ maintName, detailIdx, onCompleteComment }: MaintDetailProps) {
    ...
    const { data: postComment, refetch: refetchPostComment } = useGetMaintComment(detailIdx || "", {
