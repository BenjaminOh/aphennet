...
export default function MemberList() {
    ...
    const handleConfirmLevelChange = () => {
        if (checkedList.length === 0) {
            setConfirmPop(true, "회원을 선택해주세요.", 1);
        } else if (!level) {
            setConfirmPop(true, "변경하실 등급을 선택해주세요.", 1);
        } else {
            setConfirmPop(true, `회원의 등급을 변경하시겠습니까?`, 2, () => handleLevelChange());
        }
    };
                                    ...
                                    <ul className="flex flex-col gap-[10px]">
                                        {items.map((item, i) => (
                                            ...
                                            >
                                                ...
                                                />
                                                <p
                                                    className={`w-[20%] truncate px-[16px] text-left font-[500] text-[#222] transition-all group-hover:underline${
                                                ...
                                                <ul className="flex flex-1 gap-[20px]">
                                                    <li className="flex w-1/4 flex-col gap-[4px]">
                                                        <p className="text-[14px] text-[#9F9FA5]">회원등급</p>
                                                        <p>{item.m_level}</p>
                                                    </li>
                                                    <li className="flex w-1/4 flex-col gap-[4px]">
                                                        <p className="text-[14px] text-[#9F9FA5]">휴대폰번호</p>
                                                        <p className="truncate">{item.m_mobile}</p>
                                                    </li>
                                                    <li className="flex w-1/4 flex-col gap-[4px]">
                                                        <p className="text-[14px] text-[#9F9FA5]">이메일</p>
                                                        <p>{item.m_email}</p>
                                                    </li>
                                                    <li className="flex w-1/4 flex-col gap-[4px]">
