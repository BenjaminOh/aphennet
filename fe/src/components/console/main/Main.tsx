    ...
    useEffect(() => {
        if (connectorCountData) {
            ...
            setConnectorCountList([
                { title: "총 가입회원", count: data.boardTotalCnt },
                { title: "금일 가입회원", count: data.boardTodayCnt },
                { title: "총 방문", count: data.commentTotalCnt },
                { title: "금일 방문", count: data.commentTodayCnt },
            ]);
        }
    }, [connectorCountData]);
