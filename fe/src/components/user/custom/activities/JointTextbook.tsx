        ...
        progress: [
            ...
            },
            {
                ...
                list: [
                    ...
                    { date: "2021. 06.", content: "편집대표자 회의 (온라인)" },
                    { date: "2021. 08.", content: "편집대표자 회의 (온라인)" },
                    { date: "2021. 10.", content: "확대편집대표자회의 (온라인)" },
                    { date: "2022. 04.", content: "전체회의 (온라인)" },
                    { date: "2022. 06.", content: "편집대표자 회의 (온라인)" },
                    { date: "2022. 11.", content: "편집대표자 회의 (온라인)" },
                    { date: "2022. 12.", content: "편집대표자 회의 (온라인)" },
                ],
            },
            {
                ...
                list: [
                    ...
                    { date: "2024. 08.", content: "편집대표자 회의 (온라인)" },
                    { date: "2024. 10.", content: "편집대표자 회의 (온라인)" },
                    { date: "2024. 11.", content: "장사회의 : 전체회의(대면+온라인)" },
                    { date: "2024. 12.", content: "편집대표자 회의 (온라인)" },
                    { date: "2025. 01.", content: "편집대표자 회의 (온라인)" },
                    { date: "2025. 01~03.", content: "온라인 분과회의 및 출판사 회의 개최" },
                    { date: "2025. 08.", content: "『평화를 여는 역사』 (한국), 『신·미래를 여는 역사』 (일본) 출판" },
                ],
            },
        ],
    },
